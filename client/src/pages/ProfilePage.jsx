      ...
      rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
            ...
            cursor-pointer'>
                ...
                arrow_icon} alt="" className={`w-12 h-12 ${selectedImg && 
                'rounded-full'}`}/>
        ...
        <img className={`max-w-44 aspect-square rounded-full mx-10-sm:mt-10 ${selectedImg && 'rounded-full'}`} src={authUser?.profilePic || assets.logo_icon}alt="" />
      </div>
    </div>
  )
}
